###########################################################################
## Makefile generated for component 'SetBelt'. 
## 
## Makefile     : SetBelt.mk
## Generated on : Sun Jul 13 12:49:14 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SetBelt.exe
...
PRODUCT_NAME              = SetBelt
MAKEFILE                  = SetBelt.mk
MATLAB_ROOT               = D:\MATLAB
MATLAB_BIN                = D:\MATLAB\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\buiqu\OneDrive\Desktop\MATLAB_2024
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = SetBelt_comp.rsp
CMD_FILE                  = SetBelt.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SetBelt.exe
...
DEFINES_STANDARD = -DMODEL=SetBelt -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\SetBelt_autosar_rtw\SetBelt.c
...
{$(START_DIR)\SetBelt_autosar_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw\stub}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw\stub}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw\stub}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SetBelt_autosar_rtw\stub}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
SetBelt.obj : "$(START_DIR)\SetBelt_autosar_rtw\SetBelt.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SetBelt_autosar_rtw\SetBelt.c"
