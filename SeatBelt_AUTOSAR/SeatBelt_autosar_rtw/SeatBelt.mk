###########################################################################
## Makefile generated for component 'SeatBelt'. 
## 
## Makefile     : SeatBelt.mk
## Generated on : Mon Jul 14 23:49:25 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SeatBelt.exe
...
COMPILER_COMMAND_FILE     = SeatBelt_comp.rsp
CMD_FILE                  = SeatBelt.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SeatBelt.exe
...
DEFINES_STANDARD = -DMODEL=SeatBelt -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\SeatBelt_autosar_rtw\SeatBelt.c
...
{$(START_DIR)\SeatBelt_autosar_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw\stub}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw\stub}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw\stub}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SeatBelt_autosar_rtw\stub}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
SeatBelt.obj : "$(START_DIR)\SeatBelt_autosar_rtw\SeatBelt.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SeatBelt_autosar_rtw\SeatBelt.c"
